...
router.get("/gethall/:hall_id", async (req, res) => {
    ...
    try {
        ...
        console.log("reserved_slots", reserved_slots);
...
router.get("/getBookedrooms", async (req, res) => {
    ...
    return res.status(200).send(bookedRooms.length > 0 ? bookedRooms : "no rooms have been booked yet")
})
...
router.get("/getBookedCustomers", async (req, res) => {
    ...
    return res.status(200).send(bookedCustomers.length > 0 ? bookedCustomers : "abc")
})
